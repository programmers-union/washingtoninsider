...
const Atw = async () => {
  ...
  return (
    <div
      className={styles["ATW-section-wrapper"]}
    ...
    >
      ...
      <div
        className={styles["ATW-section-container"]}
        id="atw-scroll-container"
      >
        {atwCategory.cards.map((item, index) => {
          ...
          const categorySlug =
            atwCategory.categorySlug || "private-equity-and-venture-capital";
          ...
          return (
            ...
            >
              <div className={styles["ATW-section-card"]}>
                ...
                <p className={styles["ATW-section-source"]}>
                  Date: {item.date}
                </p>
                <p className={styles["ATW-section-content"]}>
                  {truncatedContent}
                </p>
              </div>
            </Link>
