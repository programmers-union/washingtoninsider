    ...
    <>
      <div className={styles["story-section-controls"]}>
        <div className={styles["story-section-label"]}>
          <Link href={`/${categorySlug}`} title={stories[current].title}>
            Business
          </Link>
        </div>
      ...
      <Link
        href={`/${categorySlug}/${stories[current].slug}`}
        title={stories[current].title}
      >
        <div className={styles["story-section-image-wrapper"]}>
          <Image
            ...
            blurDataURL={
              current === 0
                ? "/images/julio-herrera-financial-growth-blur.webp"
                : undefined
            }
          />
        </div>
