          ...
          <div className={styles["qdm-card"]}>
            ...
            <div className={styles["qdm-card-body"]}>
              ...
              <p className={styles["qdm-card-meta"]}>
                by{" "}
                <span className={styles["qdm-card-author"]}>{card.author}</span>{" "}
                • {card.date}
              </p>
